...
plot "`echo $elasticout`" index i u 1:2 w p ls lis 

set ylabel "u_1 (km/s)" offset 0
plot "`echo $elasticout`" index i u 1:3 w p ls lis

set ylabel "u_2 (km/s)" offset 0
plot "`echo $elasticout`" index i u 1:4 w p ls lis

set ylabel "u_3 (km/s)" offset 0 
plot "`echo $elasticout`" index i u 1:5 w p ls lis

set bmargin 4
set ylabel " {/Symbol s_{11}} (GPa)" offset 0
plot "`echo $elasticout`"index i u 1:6 w p ls lis

set ylabel " {/Symbol s_{12}} (GPa) " offset 0
plot "`echo $elasticout`" index i u 1:7 w p ls lis
...
plot "`echo $elasticout`" index i u 1:8 w p ls lis

set ylabel " {/Symbol s_{22}} (GPa) " offset 0
plot "`echo $elasticout`" index i u 1:10 w p ls lis

set ylabel " {/Symbol s_{23}} (GPa) " offset 0
plot "`echo $elasticout`" index i u 1:11 w p ls lis

set ylabel " {/Symbol s_{33}} (GPa) " offset 0
plot "`echo $elasticout`" index i u 1:14 w p ls lis

set ylabel "S" 
plot "`echo $elasticout`" index i u 1:15 w p ls lis
