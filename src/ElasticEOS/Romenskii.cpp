...
//constructor
Romenskii::Romenskii(const string& mat)
{
	double c0, b0;
...
//! Destructor
void Romenskii::checkEosConstants() const
{
	cout << "alpha " << alpha << "\nbeta " << beta <<"\ngamma "<< gamma << "\nB0 " << B0 <<  "\ncv " << cv << "\nK0 " << K0 << endl;
...
//
//
double Romenskii::internalEnergy(Vector3d I, double S) const
{
	double U, W;
	/* cout << I[2] << " cv "; */
	/* cout << "Here 3 " << endl; */
...
double Romenskii::entropy(Vector3d I, double internalEnergy) const
{	
...
Vector3d Romenskii::depsi_dI(const Vector3d I, double S) const
{
...
Matrix3d Romenskii::depsi_dI_dI(const Vector3d& I, double S) const
{
	Matrix3d depsdI2;
...
Vector3d Romenskii::depsi_dI_dS(const Vector3d& I, double S) const
{
...
double Romenskii::soundSpeed() const
{
	return sqrt(K0);
}
